...
public class SwipeRecyclerViewAdapter_Offers extends RecyclerSwipeAdapter<SwipeRecyclerViewAdapter_Offers.SimpleViewHolder> {

    private Context mContext;
    private java.util.List<OfferModel> studentList;
    ...
    public SwipeRecyclerViewAdapter_Offers(Context context, java.util.List<OfferModel> objects) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.swipe_layout_offers, parent, false);
        return new SimpleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        final OfferModel item = studentList.get(position);

        com.bumptech.glide.Glide.with(mContext)
                .load(item.getImage())
                .into(viewHolder.ig);
        viewHolder.Name.setText(item.getTitle() );
        viewHolder.Startdate.setText("Start date: "+item.getDuration1());
        viewHolder.Enddate.setText("End date: "+item.getDuration());
        viewHolder.Point.setText("Points : "+ item.getBanner());
        ...
        viewHolder.Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                OfferModel c= studentList.get(position);
                ...
                if(mContext instanceof Merchant_Rewards_list){
                    ...
                    too.putExtra("Rewarfrom",item.getDuration1());
                    too.putExtra("Rewarto",item.getDuration());
                    too.putExtra("Rewarimage",item.getImage());
                    too.putExtra("Rewarpoints",item.getBanner());
                    ...
                    too.putExtra("offerfrom",item.getDuration1());
                    too.putExtra("offerto",item.getDuration());
                    too.putExtra("offerimage",item.getImage());
                    too.putExtra("offerpoints",item.getBanner());
                    too.putExtra("Price",item.getPrice());
    ...
    public static class SimpleViewHolder extends RecyclerView.ViewHolder{
        ...
        public SimpleViewHolder(View itemView) {
            ...
            price = (TextView) itemView.findViewById(R.id.mon);
