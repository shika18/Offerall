...
public class Resetpasswordmerchant extends AppCompatActivity {
    private static final String forgotpasswordurl = "http://gp.sendiancrm.com/offerall/resetpasswordmerchant.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resetpasswordmerchant);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.equals("Token Passed")){
                            Intent too = new Intent(getApplicationContext(),newpasswordmerchant.class);
