...
public class forgotpasswordmerchant extends AppCompatActivity {
    private static final String forgotpasswordurl = "http://gp.sendiancrm.com/offerall/forgotpasswordmerchant.php";
    EditText email;
    AlertDialog alertDialog;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_forgotpasswordmerchant);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.equals("Please check your email!")){
                            Intent too = new Intent(getApplicationContext(),Resetpasswordmerchant.class);
